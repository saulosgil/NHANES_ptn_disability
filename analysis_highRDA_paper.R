...
rda_crude_svy <- survey::svyglm(formula = as.factor(INCAPAZ_CLASSE) ~ PTN_MID_HIGH, design = NHANES,
...
rda_adjusted_svy <- survey::svyglm(formula = as.factor(INCAPAZ_CLASSE) ~ PTN_MID_HIGH + GENDER + AGE + RIDRETH1 + pad_class + ENERGY_PT_MODEL + DIQ010 + BPQ020 + MCQ160B + MCQ160E,
                                   design = NHANES,
                                   family = binomial(link = "logit"))
